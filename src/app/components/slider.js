...
export default function DoubleRangeSlider() {
  ...
  const fillColor = () => {
    ...
    document.querySelector('.slider-track').style.background = `linear-gradient(to right, #CDE8E5 ${percent1}% , #41B3A2 ${percent1}% , #41B3A2 ${percent2}%, #CDE8E5 ${percent2}%)`;
  };
    ...
    <div className="w-[250px] h-[125px] gap-5 flex flex-col items-center">
      ...
      <div className="relative w-[250px] h-[52px] flex flex-col items-center">
        <div style={{backgroundColor:'#62C3C6'}} className="relative w-full h-[5px]  rounded-md mt-2">
          <div className="slider-track absolute w-full h-full rounded-md"></div>
          <input
            type="range"
            min="0"
            max="100"
