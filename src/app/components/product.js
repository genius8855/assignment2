    ...
    return (
        <div style={{borderColor: '#28E3E9'}} className=" w-[310px] h-[554px] rounded-tl-[30px] rounded-tr-[0px] rounded-br-[30px] rounded-bl-[0px] border-2 gap-[20px] ">
            ...
            <div className="w-[310px] h-[41px] pt-[20px] pr-[20px] pb-[0px] pl-[20px] flex">
                    {/* Top Section */}
                <div style={{backgroundColor: '#A10C0C0D'}} className="w-[119px] h-[21px] rounded-[30px] flex ">
                    <div style={{backgroundColor:'#A10C0C'}} className="w-[4px] h-[4px] rounded-[2px] my-auto ml-[10px] "></div>
                    <div style={{color: '#A10C0C'}} className="w-[87px] h-[15px] font-[Sora] text-[12px] font-[300] leading-[15.12px] my-auto ml-[10px]">nicht lieferbar</div>
                </div>
